...
template<class T> class List {
	...
	*/
	...
	public:
		...
		List<T> & operator + (const List<T>* List_Append);  // Listen zusammenführen zu einer Liste
		template<typename Tf> friend std::ostream & operator << (std::ostream & stream, List<Tf> const & Liste);
		// Ausgabeoperator überladen
		template<typename Tf> friend std::ostream & operator << (std::ostream & stream, List<Tf> const* Liste);
		// Ausgabeoperator überladen
		friend Node<T> * get_anker (List<T> & l);
		friend int get_AnzahlNodes (List<T> & l);
		template<typename T> friend std::ostream & operator<< (std::ostream & stream, const List<T> & Liste);
};
...
template<class T> void List<T>::insertFront (T key) {
...
template<class T> void List<T>::insertFront (List<T> & _List) {
...
template<class T> void List<T>::insertBack (T key) {
...
template<class T> void List<T>::insertBack (List<T> & _List) {
...
template<class T> bool List<T>::getFront (T & key) {
...
template<class T> bool List<T>::getBack (T & key) {
...
template<class T> bool List<T>::del (T key) {
...
template<class T> bool List<T>::swap (T key1, T key2) {
...
template<class T> bool List<T>::test (void) {
...
template<class T> List<T> & List<T>::operator + (const List<T> & List_Append) {
	// Die Methode +
...
template<class T> void List<T>::format (const std::string & start, const std::string & zwischen,
...
template<class Tf> std::ostream & operator<< (std::ostream & stream, List<Tf> const & Liste) {
