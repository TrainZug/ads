...
namespace Catch {
    namespace TestCaseTracking {
        ...
        public:
            TrackerBase(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent);
        ...
        public:
            SectionTracker(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent);
        ...
        class IndexTracker : public TrackerBase {
            ...
            int m_index = -1;
        public:
            IndexTracker(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent, int size);
...
namespace Catch {
    ...
    namespace Generators {
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            GeneratorTracker(TestCaseTracking::NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent)
                : TrackerBase(nameAndLocation, ctx, get_parent)
            {}
            ~GeneratorTracker();
...
namespace Catch {
    namespace TestCaseTracking {
        ...
        TrackerBase::TrackerBase(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent)
        ...
        ITracker& TrackerBase::get_parent() {
        ...
        SectionTracker::SectionTracker(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent)
            : TrackerBase(nameAndLocation, ctx, get_parent)
        {
            if (get_parent) {
                while (!get_parent->isSectionTracker())
                    get_parent = &get_parent->get_parent();

                SectionTracker& parentSection = static_cast<SectionTracker&>(*get_parent);
        ...
        IndexTracker::IndexTracker(NameAndLocation const& nameAndLocation, TrackerContext& ctx, ITracker* get_parent, int size)
            : TrackerBase(nameAndLocation, ctx, get_parent),
            m_size(size)
        {}
